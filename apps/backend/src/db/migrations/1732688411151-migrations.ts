...
export class Migrations1732688411151 implements MigrationInterface {
    name = 'Migrations1732688411151'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "km"."credential_schemas" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "version" character varying NOT NULL, "schema" jsonb NOT NULL, "templateVariables" text NOT NULL, "validationRules" jsonb NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_c048d0803b4cd18d8d3a2da2008" PRIMARY KEY ("id"))`);
