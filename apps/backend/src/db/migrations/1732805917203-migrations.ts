...
export class Migrations1732805917203 implements MigrationInterface {
    name = 'Migrations1732805917203'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "km"."presentation_definitions" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "version" character varying NOT NULL, "definition" jsonb NOT NULL, "isActive" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_3277761834923bc9c9334fa87b9" PRIMARY KEY ("id"))`);
