...
export class Migrations1741884732382 implements MigrationInterface {
    name = 'Migrations1741884732382'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "km"."credential_claim" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "holderDid" character varying NOT NULL, "credentialType" "km"."credential_claim_credentialtype_enum" NOT NULL, "status" "km"."credential_claim_status_enum" NOT NULL DEFAULT 'PENDING', "qrCode" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "claimedAt" TIMESTAMP, "credentialId" integer, "offerId" uuid NOT NULL, CONSTRAINT "PK_5962017beaa9254c2df3ccee852" PRIMARY KEY ("id"))`);
