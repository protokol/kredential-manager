...
export class Vc1708338889242 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `DROP TYPE "public"."verifiable_credential_status_enum"`,
        );
        await queryRunner.query(
            `DROP TYPE "public"."verifiable_credential_role_enum"`,
        );
        await queryRunner.query(
            `DROP TYPE "public"."verifiable_credential_type_enum"`,
        );
    }
}
