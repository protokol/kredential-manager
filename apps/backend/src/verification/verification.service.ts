...
const MOCK_SUBJECT_DID =
    "did:key:z2dmzD81cgPx8Vki7JbuuMmFYrWPgYoytykUZ3eyqht1j9KbrCtgZWUtK1XegWb46qLCU8i1cyF8zN3FJAu76fJf1n6hXVsbEuDhRKfe7uE3r2tt4GLxFsX166Wq3fj1Su3yUHcnaYtQjDzVo3gmW71pe14bwNsosKrKWoQU8RkLVVS3DN";
...
export class VerificationService {
    ...
    async verifyCredential(schemaId: number, data: any) {
        ...
        const verifiedCredential = await this.vpService.verifyCredential(
            signedCredential,
            "test-descriptor",
        );
    ...
    async validateData(
        ...
        const schema = await this.schemaTemplateRepository.findOne({
            where: { id: schemaId },
        });
        if (!schema) {
