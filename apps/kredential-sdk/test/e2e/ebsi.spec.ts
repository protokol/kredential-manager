...
const PRIVATE_KEY_HEX =
  "0xe75990c72548c68da2188b01e665ef4c411279260dcd2fc4107543b3220cf2cf";
...
describe("Ebsi SDK E2E Tests", () => {
  ...
  it("should create a did:key for NATURAL_PERSON from JWK", async () => {
    ...
    expect(did).toMatch(
      "did:key:z2dmzD81cgPx8Vki7JbuuMmFYrWPgYoytykUZ3eyqht1j9Kbns7ZWNqwNNXRVtDg4wQYHxn2NGgqcTG5ehNhytKPrBdEw2mpy65bAdPKxFAZPbSTkLi6rPrkGjCXXTKz4hDvPBiWXHmR1CUgdJuXPjRn9S1ooLvYzKbv5P5zxMzzkEGiqJ",
    );
  });
  ...
  it("should retrieve a public key from private key in hex format", async () => {
    ...
    expect(publicKey).toEqual(
      "04684e9b0ede8a5036b2fa1e78537f82398ff4fea0e29dfbb0a5fe25ae44f35e05b62496b3f915775011442e9e699dd2ef19a698a528a7b330d4c2486046c029fa",
    );
  });
  ...
  it("should format a private key", async () => {
    const formattedPrivateKey = await ebsi.formatPrivateKey(
      PRIVATE_KEY_HEX,
      "pem",
    );
  ...
  it("should sign a JWT with a given private key", async () => {
    ...
    const signedJwt = await ebsi.signJwt(
      PRIVATE_KEY_HEX,
      payload,
      options,
      header,
